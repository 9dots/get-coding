...
Blockly.Blocks['crossriver_pickup_monkeys'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(180);
    this.appendDummyInput()
        .appendField("pickUp(");
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["\"human\"", "human"], ["\"monkey\"", "monkey"], ["\"bigMonkey\"", "bigMonkey"]]), "ITEM");
    this.appendDummyInput()
        .appendField(");");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
...
Blockly.JavaScript['crossriver_pickup_monkeys'] = function(block) {
  var dropdown_item = block.getFieldValue('ITEM');
  var code = 'pickUp("' + dropdown_item + '");\n';
  return code;
};

Blockly.Blocks['crossriver_pickup_cops'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.setColour(180);
    this.appendDummyInput()
        .appendField("pickUp(");
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["\"cop\"", "cop"], ["\"robber\"", "robber"]]), "ITEM");
    this.appendDummyInput()
        .appendField(");");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
...
Blockly.JavaScript['crossriver_pickup_cops'] = function(block) {
  var dropdown_item = block.getFieldValue('ITEM');
  var code = 'pickUp("' + dropdown_item + '");\n';
  return code;
};
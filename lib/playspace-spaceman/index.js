...
function playspaceSpacemanCtrl($element, $timeout) {
  ...
  function pathRight() {
    ...
    if (positionRight.toString().length == 1 || Number(positionRight) < 0) positionRight= "0" + positionRight;
  ...
  function pathLeft() {
    ...
    if (positionLeft.toString().length == 1 || Number(positionLeft) < 0) positionLeft= "0" + positionLeft;
  ...
  function pathAhead() {
    ...
    if (positionAhead.toString().length == 1 || Number(positionAhead) < 0) positionAhead= "0" + positionAhead;
  ...
  vm.field = {
    ...
    randomAsteroidType: _.memobyIize(function(pos) {

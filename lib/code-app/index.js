...
.controller('AppCtrl', function(appRunner, apps, $location, $rootScope, $mdDialog, $timeout, $mdSidenav) {
  ...
  function activate() {
    ...
    vm.helpTitle = "MISSION";
    vm.helpText = vm.levels[vm.level].mission;
    vm.missionOn = true;
    vm.toolsOn = false;
    vm.tipsOn = false;
    vm.missionMan = "up";
  ...
  function setHelp(type){
    ...
    if(type === "Mission"){
      ...
      vm.helpText = vm.levels[vm.level].tools;
      vm.toolsOn = true;
      vm.missionMan = "out";
    } else if (type === "Tips"){
      vm.helpText = vm.levels[vm.level].tips;
      vm.tipsOn = true;
      vm.missionMan = "down";
    }
  ...
  function showSuccess(level){
      ...
      var dialogText = 'You wrote ' + vm.locUsed + ' lines of code!';
